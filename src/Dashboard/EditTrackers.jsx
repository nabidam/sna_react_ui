...
class EditTrackers extends React.Component {
  constructor(props) {
    super(props);
    console.log("edit trackers constructor");
    console.log(props);
    this.state = {
      instagramUsers: [],
      twitterUsers: [],
  ...
  handleSeletProject = project => {
    this.setState({
      ...
      editableTracker: {
        ...this.state.editableTracker,
        selectedProject: project
      }
    });

    this.handleCloseSelectProject();
    this.props.changeEditableTracker({
      ...this.state.editableTracker,
      selectedProject: project
    });
  };
    ...
    if (e.keyCode == 13 && e.target.value != "") {
      this.setState({
        ...
        editableTracker: {
          ...this.state.editableTracker,
          social: {
            ...this.state.editableTracker.social,
            instagramUsers: [...this.state.instagramUsers, e.target.value]
          }
        }
      });
  ...
  handleEnableLocation = () => {
    this.setState({
      ...
      editableTracker: {
        ...this.state.editableTracker,
        lacation: {
          ...this.state.editableTracker.lacation,
          isLocationEnable: !this.state.isLocationEnable
        }
      }
    });
  ...
  componentDidMount = () => {
    this.setState({
      instagramUsers: this.props.editableTracker.social.instagramUsers,
      twitterUsers: this.props.editableTracker.social.twitterUsers,
      hashtags: this.props.editableTracker.hashtags,
      keywords: this.props.editableTracker.keywords,

      twitter: this.props.editableTracker.social.twitter,
      instagram: this.props.editableTracker.social.instagram,

      isLocationEnable: this.props.editableTracker.location.isLocationEnable,
      isMapChangable: this.props.editableTracker.location.isLocationEnable,
      mapCenter: this.props.editableTracker.location.center,

      selectedProject: this.props.editableTracker.selectedProject,

      selectedDay: this.props.editableTracker.selectedDay,
      isDaySelected: this.props.editableTracker.isDaySelected,

      editableTracker: this.props.editableTracker,
      editableTrackerName: this.props.editableTracker.name
    });
  };
            ...
            <Grid container className={classes.root} spacing={2}>
              <Grid item md={6} sm={6} xs={12}>
                ...
                <input
                  ...
                  value={
                    this.state.editableTracker
                      ? this.state.editableTracker.name
                      : ""
                  }
...
const mapStateToProps = state => {
  ...
  return {
    ...
    editableTracker: trackers.editableTracker
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    changeEditableTracker: data =>
      dispatch(TrackersActions.changeEditableTracker(data))
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles, { withTheme: true })(EditTrackers));
