...
class AddTrackersHeader extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleClickAddTracker = () => {
    const addTracker = this.props.addTracker;
    if (addTracker.name != "") {
                ...
                <Grid container wrap="nowrap" spacing={2}>
                  <Grid item xs zeroMinWidth className={classes.cardText}>
                    <Button
                      ...
                      onClick={() => this.handleClickAddTracker()}
                    >
                      ایجاد ردیاب
                    </Button>
                  </Grid>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    createTracker: () => dispatch(TrackersActions.createTracker())
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles, { withTheme: true })(AddTrackersHeader));
