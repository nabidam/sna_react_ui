...
class EditTrafficAnalysisHeader extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleEditTrafficAnalysis = () => {
    ...
    history.push("/dashboard/traffic-analysis");
  ...
  handleCancelEdit = () => {
    this.props.changeEditableTrafficAnalysis(null);
    this.props.selectPage("traffic-analysis");
    history.push("/dashboard/traffic-analysis");
  };
...
EditTrafficAnalysisHeader.propTypes = {};
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    deleteTrafficAnalysis: trafficAnalysis =>
      dispatch(TrafficAnalysisActions.deleteTrafficAnalysis(trafficAnalysis)),
    editTrafficAnalysis: () =>
      dispatch(TrafficAnalysisActions.editTrafficAnalysis()),
    changeEditableTrafficAnalysis: trafficAnalysis =>
      dispatch(
        TrafficAnalysisActions.changeEditableTrafficAnalysis(trafficAnalysis)
      )
  };
};
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles, { withTheme: true })(EditTrafficAnalysisHeader));
