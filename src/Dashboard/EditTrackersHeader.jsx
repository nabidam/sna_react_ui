...
class EditTrackersHeader extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleEditTracker = () => {
    this.props.changeEditableTracker(this.props.editableTracker);
  ...
  handleDeleteTracker = () => {
    this.props.deleteTracker(this.props.editableTracker);
    this.props.selectPage("trackers");
    history.push("/dashboard/trackers");
  };

  handleCancelEdit = () => {
    this.props.changeEditableTracker(null);
    this.props.selectPage("trackers");
    history.push("/dashboard/trackers");
  };
                ...
                <Grid container wrap="nowrap" spacing={2}>
                  <Grid item xs zeroMinWidth className={classes.cardText}>
                    <Button
                      ...
                      onClick={() => this.handleEditTracker()}
                    >
                      ثبت تغییرات
                    </Button>
                    <Typography
                      ...
                      onClick={() => this.handleDeleteTracker()}
                    >
                      حذف ردیاب
                    </Typography>
                  </Grid>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    deleteTracker: tracker => dispatch(TrackersActions.deleteTracker(tracker)),
    editTracker: () => dispatch(TrackersActions.editTracker()),
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withStyles(styles, { withTheme: true })(EditTrackersHeader));
